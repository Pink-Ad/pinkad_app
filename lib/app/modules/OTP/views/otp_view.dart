  ...
  Widget build(BuildContext context) {
    return Stack(
      children:  [
                    ...
                    children: [
                      Container(
                        ...
                        child: OtpTextField(
                          ...
                          numberOfFields: 4,
                          borderWidth: 0.0,
                          enabledBorderColor: Colors.transparent, // set transparent to hide the border color
                          focusedBorderColor: Colors.transparent,
                          borderColor: secondary,
                          cursorColor: textColor,
                          textStyle: CustomTextView.getStyle(context,
                          ...
                          onSubmit: (String verificationCode) {
                            showDialog(
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    title:  Text("Verification Code" , style: CustomTextView.getStyle(context,
                                        colorLight: bodyTextColor),),
                                    content: Text(
                                        'Code entered is $verificationCode', style: CustomTextView.getStyle(context,
                                        colorLight: bodyTextColor),),
                                  );
                                });
                          }, // end onSubmit
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.snackbar("Sent", "OTP send to your number",
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const SizedBox(
                               ...
                               Text("Resend Code" ,style: CustomTextView.getStyle(context,
                                  colorLight: bodyTextColor),),
                            ],
                          ),
                        ),
        ...
        Align(alignment: Alignment.bottomCenter, child: BottomButtons(buttonText: "AS USER", onTap: (){ Get.toNamed(Routes.USER_LOGIN);},)),
      ]
    );
  }
}
