            ...
            children: [
              Text("Enter OTP",
                  style: CustomTextView.getStyle(context,
                      fontSize: 24.sp, fontFamily: "Radomir Tinkov - Gilroy-ExtraBold", fontWeight: FontWeight.w700)),
              SizedBox(
                height: 7.0.h,
              ),
                  ...
                  children: [
                    Container(
                      ...
                      child: OtpTextField(
                        ...
                        textStyle: CustomTextView.getStyle(context, colorLight: bodyTextColor),
                        filled: true,
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.snackbar("Sent", "OTP send to your number",
                            colorText: Colors.white, backgroundColor: primary, snackPosition: SnackPosition.BOTTOM);
                      },
                      child: Container(
