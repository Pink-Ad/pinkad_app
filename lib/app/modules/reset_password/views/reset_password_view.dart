...
import 'package:pink_ad/app/modules/user_login/views/user_login_view.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GlobalButton(
                        ...
                        onPressed: () {
                          Get.toNamed("/login");
                          Get.snackbar("Successful", "Your password has been changed." , backgroundColor: primary , colorText: Colors.white , snackPosition: SnackPosition.TOP);
                        },
